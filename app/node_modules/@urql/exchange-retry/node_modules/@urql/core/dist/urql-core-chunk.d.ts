 ...
 */
type PromisifiedSource<T = any> = Source<T> & {
    toPromise: () => Promise<T>;
};
...
export { AnyVariables, CacheOutcome, Client, ClientOptions, CombinedError, DebugEvent, DebugEventArg, DebugEventTypes, Exchange, ExchangeIO, ExchangeInput, ExecutionResult, GraphQLRequest, GraphQLRequestParams, IncrementalPayload, Operation, OperationContext, OperationDebugMeta, OperationInstance, OperationResult, OperationType, PromisifiedSource, RequestPolicy, TypedDocumentNode, createClient };
